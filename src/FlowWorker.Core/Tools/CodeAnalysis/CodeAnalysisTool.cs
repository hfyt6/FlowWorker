...
namespace FlowWorker.Core.Tools.CodeAnalysis;
...
public class CodeAnalysisTool : IToolHandler
{
    ...
    public async Task<ToolResponse> ExecuteAsync(string action, JsonElement parameters)
    {
        return action.ToLowerInvariant() switch
        {
            ...
            "read_code" => await ParseCodeAsync(parameters),
            "search_code" => await FindFunctionAsync(parameters),
            "analyze_code" => await AnalyzeComplexityAsync(parameters),
