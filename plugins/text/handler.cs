...
namespace FlowWorker.Plugins.Text
{
    /// <summary>
    /// 文本处理工具处理器
    /// </summary>
    public class TextHandler
    {
        ...
        /// 文本搜索，支持正则表达式
        /// </summary>
        public Task<ToolResponse> SearchTextAsync(JsonElement parameters)
        {
            try
            {
        ...
        /// 文本替换，支持正则表达式
        /// </summary>
        public Task<ToolResponse> ReplaceTextAsync(JsonElement parameters)
        {
            try
            {
                var text = parameters.GetProperty("text").GetString();
        ...
        /// 统计文本行数
        /// </summary>
        public Task<ToolResponse> CountLinesAsync(JsonElement parameters)
        {
            try
            {
                var text = parameters.GetProperty("text").GetString();
        ...
        /// JSON格式化
        /// </summary>
        public Task<ToolResponse> FormatJsonAsync(JsonElement parameters)
        {
            try
            {
                ...
                {
                    return Task.FromResult(ToolResponse.Error("INVALID_PARAMETERS", "JSON字符串不能为空"));
                }
                ...
                {
                    return Task.FromResult(ToolResponse.Error("INVALID_JSON", $"JSON解析错误: {ex.Message}"));
                }
            }
            catch (Exception ex)
            {
        ...
        /// JSON验证
        /// </summary>
        public Task<ToolResponse> ValidateJsonAsync(JsonElement parameters)
        {
            try
            {
                var jsonString = parameters.GetProperty("json_string").GetString();
