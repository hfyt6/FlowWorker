...
namespace FlowWorker.Plugins.FileSystem
{
    /// <summary>
    /// 文件系统操作工具处理器
    /// </summary>
    public class FileSystemHandler
    {
        ...
        /// 读取文件内容
        /// </summary>
        public async Task<ToolResponse> ReadFileAsync(JsonElement parameters)
        {
            try
            {
        ...
        /// 写入文件内容
        /// </summary>
        public async Task<ToolResponse> WriteFileAsync(JsonElement parameters)
        {
            try
            {
                var filePath = parameters.GetProperty("file_path").GetString();
        ...
        /// 列出目录文件
        /// </summary>
        public Task<ToolResponse> ListFilesAsync(JsonElement parameters)
        {
            try
            {
        ...
        /// 检查文件是否存在
        /// </summary>
        public Task<ToolResponse> FileExistsAsync(JsonElement parameters)
        {
            try
            {
                var filePath = parameters.GetProperty("file_path").GetString();
        ...
        /// 删除文件
        /// </summary>
        public Task<ToolResponse> DeleteFileAsync(JsonElement parameters)
        {
            try
            {
                var filePath = parameters.GetProperty("file_path").GetString();
        ...
        /// 创建目录
        /// </summary>
        public Task<ToolResponse> CreateDirectoryAsync(JsonElement parameters)
        {
            try
            {
                var directoryPath = parameters.GetProperty("directory_path").GetString();
